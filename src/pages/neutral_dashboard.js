...
import { ClosedConflictIcon, OngoingConflictIcon, OpenConflictIcon } from "../components/IconComponent/NeutralsDashboardIcons";
  ...
  return (
    ...
    <div className="mx-auto w-100 px-3 px-lg-5">
      <div className="row gx-lg-3 justify-content-between align-items-center mt-5 ps-sm-2">
          <DashboardConflictCards value="100" text="Open Conflicts" icon={<OpenConflictIcon/>} />
      <DashboardConflictCards value="75" text="Ongoing Conflicts" icon={<OngoingConflictIcon/>}/>
      <DashboardConflictCards value="250" text="Closed Conflicts" icon={<ClosedConflictIcon/>}/>
      </div>
