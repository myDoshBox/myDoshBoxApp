  ...
  return (
    <>
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body className='border border-0 ModalMessage'>Buyer Opeyemi has successfully confirmed delivery of transaction ID 2D47HJ7 and the sum of 3000naira has been paid to your account in the next 24 hours</Modal.Body>
