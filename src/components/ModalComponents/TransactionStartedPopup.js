  ...
  return (
    <>
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body className='text-justify border border-0 ModalMessage'>Seller Ellandrofiles has just been notified of the transaction you created. You will be notified once the seller has accepted the transaction</Modal.Body>
  ...
  return (
    <>
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body className='text-justify border border-0 ModalMessage'>Buyer Ellandrofiles has just been notified of the transaction you created. You will be notified once the Buyer has accepted the transaction</Modal.Body>
        <Modal.Footer className='border border-0 text-center justify-content-center pt-0'>
          <Button className="border border-0 Modal-Btn" variant="primary" onClick={handleClose}>
            Notifications
          </Button >
